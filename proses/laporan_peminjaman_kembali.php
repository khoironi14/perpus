<?php
    ...
    $nama_dokumen = "LAPORAN BERDASARKAN TANGGAL KEMBALI " . date("Y-m-d H:i:s a");
    $mpdf = new \Mpdf\Mpdf();
ob_start();
?>
    <div>
    ...
    <h3 style="text-align: center; line-height: 0.1%">LAPORAN BERDASARKAN TANGGAL KEMBALI</h3>
    <div>
            ...
            <tr>
                <?php
                    ...
                    $nisLaporan = mysqli_real_escape_string($koneksi, $_GET["nisLaporan"]);
                        ...
                        $qPinjam = mysqli_query($koneksi, "SELECT * FROM tb_kembali k JOIN tb_buku b ON k.id_buku = b.id_buku  JOIN tb_anggota a ON a.nis = k.nis WHERE k.tgl_kembali BETWEEN '$dari' and '$ke'");

...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jan 2020 pada 17.36
...
(1, 1, 'kd1', 'Jomblo Sejati Tapi Besok Rabi', 'Mas Umar', 'Umar aja', '2019-12-01', 6),
(2, 2, 'kd2', 'Jomblo Sejati', 'Mas Umar', 'Umar aja', '2019-12-02', 11),
(3, 0, 'kd3', 'Jomblo Sejati 2', 'Mas Umar', 'Umar aja', '2019-12-02', 11);
...
(2, 2, 2, 112233, '2020-01-06 16:33:29', '2020-01-09 16:33:29', '0', 0),
(3, 3, 3, 112233, '2020-01-06 16:33:31', '2020-01-09 16:33:31', '0', 0),
(5, 2, 0, 112233, '2020-01-09 17:20:14', '2020-01-12 17:20:14', '0', 0);
...
CREATE TABLE `tb_pinjam` (
  ...
  `denda` varchar(20) NOT NULL,
  `statusku` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_pinjam` (`id_pinjam`, `id_buku`, `nis`, `tgl_pinjam`, `tgl_kembali`, `tgl_terima`, `denda`, `statusku`) VALUES
(2, 2, 112233, '2020-01-06', '2020-01-08 16:55:31', '', '0', 2),
(3, 3, 112233, '2020-01-06 16:33:31', '2020-01-05 16:33:31', '2020-01-13 17:31:35', '5000', 2),
(5, 2, 112233, '2020-01-09 17:20:14', '2020-01-12 17:20:14', '', '0', 2);

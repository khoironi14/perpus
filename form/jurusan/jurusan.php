...
<?php
        $page = (isset($_GET['pageJurusan']))? $_GET['pageJurusan'] : 1; // Cek apakah terdapat data page pada URL
        $limit = 10; // Jumlah data per halamannya
        // Untuk menentukan dari data ke berapa yang akan ditampilkan pada tabel yang ada di database      
        $limit_start = ($page - 1) * $limit;
        // Buat query untuk menampilkan data siswa sesuai limit yang ditentukan          
        $sql = mysqli_query($koneksi, "SELECT * FROM tb_jurusan LIMIT ".$limit_start.",".$limit);  
...
<div class="card">  
    <div class="card-header bg-primary mb-3">
        ...
        <ul class="pagination" <?php if($cekJurusan == null){ echo "style='display:none'";} ?>>
            <?php        
            ...
            ?>
                ...
                <li class="disabled" style="display: none">
                    ...
                    ?>
                <li>
                    <a class="page-link" href="index.php?pageJurusan=1">First</a></li>
                        <li><a class="page-link" href="index.php?pageJurusan=<?php echo $link_prev; ?>">&laquo;</a></li>  
                    <?php    
                        }        
                    ?>
                ...
                <?php        
                    ...
                    $sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM tb_jurusan");   
                    ...
                    for($i = $start_number; $i <= $end_number; $i++){          
                        ...
                        <!-- <li<?php echo $link_active; ?>><a class="page-link" href="index.php?pageJurusan=<?php echo $i; ?>"> -->
                        <!-- <?php echo $i; ?></a></li>         -->
                        <?php        
                            }        
                ?>                
        ...
        <li class="disabled" style="display: none">
            ...
            <li class="disabled" style="display: none"><a href="#">Last</a></li>        
                <?php        
                    ...
                    ?>          
                        <li>
                            <!-- <a class="page-link" href="index.php?pageJurusan=<?php echo $link_next; ?>">&raquo;</a></li> -->
                                <!-- <li><a class="page-link" href="index.php?pageJurusan=<?php echo $jumlah_page; ?>">Last</a></li>         -->
                <?php        
                    }        
                ?>      
            </ul>
